...
![a) Hourly Distribution](plots/final/at_a_glance_crash_hour_polished.png){width="250"}{#fig-hourly}

![b) Weekly Distribution](plots/final/at_a_glance_crash_day_polished.png){width="250"}{#fig-weekly}

![c) Monthly Distribution](plots/final/at_a_glance_crash_month_polished.png){width="250"}{#fig-monthly}
...
![Figure 4: Cause vs. Injury Frequency](plots/final/looking_deeper_cause_v_injury_final.png){width="250"}
...
![Figure 4: Cause vs. Injury Frequency](plots/final/looking_deeper_crash_type_v_most_severe_injury_final.png)

### Does the occurrence of weather as a contributory cause fluctuate by season?

I was initially surprised in @fig-monthly that there were fewer crashes (see the complete list of contributory causes in @tbl-contributory-causes)
